	...
	<div id="content">
		...
		<div id="center">
			...
			<div class="center_center">
				<div class="nav_div">
					<a href="individualCenter.action"><button class="nav_btn">个人中心</button></a><a><button
							class="nav_btn">个人资料</button></a><a><button class="nav_btn">网站导航</button></a>

				</div>
				<div class="update_password">
					<form action="sendNewPassword.action" method="post">
						请输入<span style="color: red">新密码</span>：<input name="password" type="password" style="height: 25px;">
